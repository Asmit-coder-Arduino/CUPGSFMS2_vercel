...
export function SplashScreen({ onDone }: { onDone: () => void }) {
  ...
  return (
    <div
      ...
      style={{
        background: "radial-gradient(ellipse at 30% 20%, rgba(109,40,217,0.35) 0%, transparent 55%), radial-gradient(ellipse at 75% 80%, rgba(37,99,235,0.2) 0%, transparent 55%), linear-gradient(160deg, #06030f 0%, #080c1a 55%, #030810 100%)"
      }}
    >
      {/* Soft glow mesh */}
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #c4b5fd 0%, #a78bfa 40%, #818cf8 70%, #93c5fd 100%)",
            ...
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
              <defs>
                <linearGradient id={`sg${i}`} x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stopColor={i <= 4 ? "#a78bfa" : "#a78bfa44"} />
                  <stop offset="100%" stopColor={i <= 4 ? "#7c3aed" : "#7c3aed44"} />
                </linearGradient>
              </defs>
              <polygon
                points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"
                fill={`url(#sg${i})`}
                stroke={i <= 4 ? "#8b5cf6" : "#8b5cf644"}
                strokeWidth="1"
      ...
      <div
        ...
        style={{ width: 140, height: 3, background: "rgba(139,92,246,0.12)" }}
      >
        <div
          className="h-full rounded-full"
          style={{
            background: "linear-gradient(90deg, #8b5cf6, #a78bfa, #818cf8)",
